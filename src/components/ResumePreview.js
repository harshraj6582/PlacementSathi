      ...
      >
        <div ref={printElem}>
          <HStack>
            ...
            <VStack m={4} alignItems={"flex-start"} spacing={0.5}>
              <Heading as="h4" size="md">
                {about.name ? about.name : "Harsh Raj "}
              </Heading>
              <Text color={"gray.500"}>
          ...
          >
            <HStack spacing={1}>
              <MdMail />{" "}
              <Text>{about.email ? about.email : "harshraj211430@gmail.com"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocalPhone />{" "}
              <Text>{about.phone ? about.phone : "+9100020030004"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocationPin />{" "}
              <Text>{about.address ? about.address : "Patna"}</Text>
            </HStack>
            <HStack spacing={1}>
              <RiLinkedinBoxFill />{" "}
                  ...
                  return (
                    ...
                    >
                      <Text fontWeight={"medium"}>
                        {degree ? degree : "B.Tech Electronics and Communication Engineering"}
                      </Text>
                      <Text fontSize={"sm"}>
                        {school ? school : "Jaypee University Of Information Technology"}
                      </Text>
                      <HStack
                        fontSize={"xs"}
                        fontStyle={"italic"}
                      ...
                      >
                        ...
                        <Text>{grade ? grade : "8.9 CGPA"}</Text>
                      </HStack>
                    </VStack>
                  );
                })}
                ...
                {workList.map((work) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text fontSize={"sm"}>
                        {company ? company : "XYZ IT Services"} -{" "}
                        {type ? type : "Full-time"}
                      </Text>
